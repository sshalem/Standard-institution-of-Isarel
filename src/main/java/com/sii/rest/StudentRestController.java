...
public class StudentRestController {
	...
	public Student getStudentIdentity(@PathVariable("identity") String identity) {

		LOGGER.info("facade: " + studentFacade.hashCode());
		LOGGER.info("context: " + ctx.getBean(StudentFacade.class).hashCode());

		return studentFacade.getByStudentIdentification(identity);
//		return ctx.getBean(StudentFacade.class).getByStudentIdentification(identity);
	}
